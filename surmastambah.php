  ...
  <body>
	<div class="row no-gutters pr-3">
		...
		<div class="left col-md-10 p-3 mt-3">
			<div class="mt-2 ml-5 pt-2 pl-1 mr-2"><h3><i class="far fa-paper-plane"></i> TAMBAH SURAT MASUK</h3> <hr></div>
            <div class="ml-5 pl-1 p-3">
                ...
                <?php echo'<form action="surmastambah.php" method="POST">'; ?>
                    <div class="form-group">
                        ...
                        <input type="text" name="tanggal_masuk" class="form-control form-control-lg" placeholder="YYYY-MM-DD">
                    </div>
                    <div class="form-group">
